    ...
    >
      <>
        ...
        <div className="relative pt-[56.25%]">
          <ReactPlayer
            url={`https://www.youtube.com/watch?v=${movie?.key}`} //{`https://www.youtube.com/watch?v=UQeTCD-VD2Y`} // ${trailer}`}
            width="100%"
            height="100%"
          ...
          <div className="absolute bottom-10 flex w-full items-center justify-between px-10     ">
            <div className="flex space-x-2" >
              <button className="flex items-center gap-x-2 rounded  bg-white px-8 text-xl font-bold text-black transition hover:bg-[gray]/70" >
                <FaPlay className="h-7 w-9 text-black" />
                <Link href="#down">
        ...
        <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8  ">
          ...
          <div className="space-y-6 text-lg">
            ...
            <div id="down" ref={rowRef}>
              ...
              <ChapterPage movies={movie?.chapters} />
            </div>
          </div>
